...
public class DepartmentController : ApiControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Add([FromBody] DepartmentRequest modelRequest)
    {
    ...
    [HttpPut("{id}")]
    public async Task<IActionResult> Update(int id, [FromBody] DepartmentRequest modelRequest)
    {
