...
public static class ExternalDocumentMapping
{
    public static Expression<Func<Document, ExternalDocumentResponse>> SelectResponseExpression = x => new ExternalDocumentResponse
    {
        Id = x.Id,
    ...
    public static Expression<Func<Document, ExternalDocumentDetailResponse>> SelectDetailResponseExpression = x => new ExternalDocumentDetailResponse
    {
        Id = x.Id,
        Name = x.Name,
    ...
    public static Document ToEntity(this ExternalIncomingDocumentRequest documentRequest) => new()
    {
    ...
    public static Document ToEntity(this ExternalOutgoingDocumentRequest documentRequest) => new()
    {
        Name = documentRequest.Name,
    ...
    public static void MappingFieldFrom(this Document trackedEntity, ExternalIncomingDocumentRequest request)
    {
        ...
        trackedEntity.OrganizationId = request.OrganizationId;
    ...
    public static void MappingFieldFrom(this Document trackedEntity, ExternalOutgoingDocumentRequest request)
    {
        trackedEntity.Name = request.Name;
